  ...
  switch (action.type) {
    ...
    case ACTUALIZAR_TAREA:
      return {
        ...
        //para el problema de volver tareaseleccionada a cero podria poner: tareaseleccionada:null(cosa que ya hice en alguns casos); pero voy a probar otra manera
      };
    case TAREA_ACTUAL:
      return {
        ...state,
